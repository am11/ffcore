...
namespace ff
{
	...
	UTIL_API const XMFLOAT4&   GetColorWhite();
	UTIL_API const XMFLOAT4&   GetColorBlack();
	UTIL_API const XMFLOAT4&   GetColorNone();
	UTIL_API const XMFLOAT4X4& GetIdentityMatrix();
	...
	struct AnimPos
	{
		...
		UTIL_API void GetMatrix(XMMATRIX &matrix) const;
	};
