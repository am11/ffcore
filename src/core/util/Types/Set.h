...
namespace ff
{
	...
	private:
		...
		SEntry *GetEntry(BucketIter pos) const         { return reinterpret_cast<SEntry *>(pos); }
		BucketIter GetBucketIter(SEntry *pEntry) const { return reinterpret_cast<BucketIter>(pEntry); }
